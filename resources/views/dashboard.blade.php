...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet"  type="text/css" href="{{{('backend/plugins/fontawesome-free/css/all.min.css')}}}">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" type="text/css" href="{{{('backend/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}}">
  <!-- Theme style -->
  <link rel="stylesheet"  type="text/css"href="{{{('backend/dist/css/adminlte.min.css')}}}">
</head>
