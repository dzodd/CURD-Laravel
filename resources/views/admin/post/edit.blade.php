                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mota" class="form-control" placeholder=""  value="{{ $post->mota }}"/>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kind_id" id="" required="" class="form-control">
                                                    ...
                                                    @foreach ($kinds as $kind)
                                                        <option   value="{{ $kind->id }}" @if($kind->id==$post->kind_id)  selected="" @endif>{{ $kind->name }}" </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group clearfix">
                                    <div class="icheck-primary d-inline">
                                        <input type="radio" id="radioPrimary3" name="status" value="1"   {{ $post->status == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="radioDanger1" name="status" value="0"   {{ $post->status == '0' ? 'checked' : '' }}>
